package com.guigu.audition.two.gc;
 ...
 *
 *  5. -Xms10m -Xmx10m -XX:+PrintGCDetails -XX:+PrintCommandLineFlags -XX:+UseConcMarkSweepGC  (par new generation + concurrent)
 *
 *  6. -Xms10m -Xmx10m -XX:+PrintGCDetails -XX:+PrintCommandLineFlags -XX:+UseG1GC  后面单独讲解G1
 *
 *  7.（理论指导即可，实际中java8已被优化掉了，没有了）
